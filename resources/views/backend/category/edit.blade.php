	...
	@section ('admin.head_title','Sửa thể loại - Comic v1.0')

	@section ('admin.header')
	<link rel="stylesheet" type="text/css" href="{{ url('/public/backend') }}/assets/css/lib/datatable/dataTables.bootstrap.min.css" />
<!-- include summernote css/js -->
<link href="{{ url('/public/editor') }}/summernote.css" rel="stylesheet">
<script src="{{ url('/public/editor') }}/summernote.js"></script>
	@stop
