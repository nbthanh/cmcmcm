                       ...
                       <div class="col-sm-12 col-md-6">
                           <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="txtCatname" placeholder="Nhập tên thể loại" class="form-control" value="{!! old('txtCatname') !!}">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="txtCatorder" placeholder="Nhập số thứ tự" class="form-control" value="{!! old('txtCatorder', 0) !!}">
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-10">
                                  <textarea name="txtCatdes" id="catDes" rows="9" placeholder="Description..." class="form-control">{!! old('txtCatdes') !!}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-11">
                                  <textarea name="txtCatcontent" id="catContent" rows="9" placeholder="Content..." class="form-control">{!! old('txtCatcontent') !!}</textarea>
