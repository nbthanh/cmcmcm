...
@section ('admin.head_title','Welcome to administrator - Comic v1.0')
...
<div class="col-xl-3 col-lg-6">
    <section class="card">
        <div class="twt-feed blue-bg">
            ...
            <div class="media">
                <a href="#">
                    <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="{{ url('/public/backend/') }}/images/admin.jpg">
                </a>
